...
CREATE TABLE "Access" (
    ...
    "createReviewQuestions" BOOLEAN NOT NULL,
    ...
    "readReviewQuestions" BOOLEAN NOT NULL,
    ...
    "updateReviewQuestions" BOOLEAN NOT NULL,
    ...
    "deleteReviewQuestions" BOOLEAN NOT NULL,
