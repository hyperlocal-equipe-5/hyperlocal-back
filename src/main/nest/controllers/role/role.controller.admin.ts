...
export class RoleControllerAdmin {
  ...
  @ApiOperation({
    summary:
      'Route that an authorized account can create a new role for a restaurant.',
  })
  @ApiBearerAuth()
  @Post()
  ...
  @ApiOperation({
    summary:
      'Route that an authorized account can delete a role from a restaurant.',
  })
  @ApiBearerAuth()
  @Delete(':id')
  async delete(
  ...
  @ApiOperation({
    summary:
      'Route that an authorized account can update a role from a restaurant.',
  })
  @ApiBearerAuth()
  @Patch(':id')
  ...
  @ApiOperation({
    summary:
      'Route that an authorized account can get one role from a restaurant.',
  })
  @ApiBearerAuth()
  @Get(':id')
  async getOne(
  ...
  @ApiOperation({
    summary:
      'Route that an authorized account can get all roles from a restaurant.',
  })
  @ApiBearerAuth()
  @Get()
