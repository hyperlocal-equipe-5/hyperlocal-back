...
export class CategoryControllerAdmin {
  ...
  @ApiOperation({
    summary:
      'Route that an authorized account can create a new category from a restaurant.',
  })
  @Post()
  ...
  @ApiOperation({
    summary:
      'Route that an authorized account can delete a category from a restaurant.',
  })
  @ApiBearerAuth()
  @Delete(':id')
  ...
  @ApiOperation({
    summary:
      'Route that an authorized account can upgrade a category from a restaurant.',
  })
  @ApiBearerAuth()
  @Patch(':id')
