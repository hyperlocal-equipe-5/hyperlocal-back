...
export class IngredientControllerAdmin {
  ...
  @ApiOperation({
    summary:
      'Route that an authorized account can create a new ingredient from a restaurant.',
  })
  @ApiBearerAuth()
  @Post()
  ...
  @ApiOperation({
    summary:
      'Route that an authorized account can delete an ingredient from a restaurant.',
  })
  @ApiBearerAuth()
  @Delete(':id')
  ...
  @ApiOperation({
    summary:
      'Route that an authorized account can update an ingredient from a restaurant.',
  })
  @ApiBearerAuth()
  @Patch(':id')
