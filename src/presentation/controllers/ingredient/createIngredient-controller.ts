...
export class CreateIngredientController implements CreateIngredientInterface{
  ...
  public constructor(createIngredientUseCase: CreateIngredientUseCaseInterface){
  ...
  try {
    ...
    const createdIngredient = await this.createIngredientUseCase.execute(createIngredientDto)
